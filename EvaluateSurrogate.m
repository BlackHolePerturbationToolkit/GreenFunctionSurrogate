...
$SurrogateFile[0] = FileNameJoin[{FileNameDrop[FindFile["GreenFunctionSurrogate`"], -2], "G_sur_s0_sigma0.1_h0.01_t240_hyp.h5"}];
$SurrogateFile[2] = FileNameJoin[{FileNameDrop[FindFile["GreenFunctionSurrogate`"], -2], "G_sur_s2_sigma0.1_h0.01_t240_hyp.h5"}];
